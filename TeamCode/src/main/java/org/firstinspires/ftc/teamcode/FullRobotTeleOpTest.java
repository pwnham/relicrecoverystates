...
/**
 * Created by moham on 12/10/17.
 */
@TeleOp
public class FullRobotTeleOpTest extends OpMode{
...
//        conveyorRightStart = conveyorRight.getPosition();
    ...
    public void loop() {
        ...
        if (gamepad1.left_bumper) {
            rightBack.setPower(gamepad1.right_stick_y * driveMultiplier * .3);
            rightFront.setPower(gamepad1.right_stick_y * driveMultiplier * .3);
            leftBack.setPower(gamepad1.left_stick_y * driveMultiplier * .3);
            leftFront.setPower(gamepad1.left_stick_y * driveMultiplier * .3);
        } else {
            rightBack.setPower(gamepad1.right_stick_y * driveMultiplier * .7);
            rightFront.setPower(gamepad1.right_stick_y * driveMultiplier * .7);
            leftBack.setPower(gamepad1.left_stick_y * driveMultiplier * .7);
            leftFront.setPower(gamepad1.left_stick_y * driveMultiplier * .7);
        }
